...
//key: "7d1f097f-9809-45eb-99df-4a382f2e9ce1"
...
export const SelectRepositoriesStep =
  compose(
    ...
    class _SelectRepositoriesStep extends React.Component {
      render() {
        const {selectedConnector, selectedRepositories, onRepositoriesSelected, trackingReceiptCompleted, onDoImport} = this.props;
