...
import {DEMO_MODE, FLOW_EFFICIENCY_DASHBOARDS} from "../../config/featureFlags";
...
export function useFlowEfficiencyDashboardsFeatureFlag() {
  const context = useViewerContext();
  return context.isFeatureFlagActive(FLOW_EFFICIENCY_DASHBOARDS);
}