...
function queue(stroke) {
  return `<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="64" height="64" fill="none"/>
            <line x1="22" y1="17" x2="22" y2="46.3333" stroke="${stroke}" stroke-width="2"/>
            <line x1="11" y1="16" x2="23" y2="16" stroke="${stroke}" stroke-width="2"/>
            <line x1="11" y1="47" x2="23" y2="47" stroke="${stroke}" stroke-width="2"/>
            <circle cx="38" cy="32" r="15" fill="none" stroke="${stroke}" stroke-width="2"/>
          </svg>
`
}
function sitemap() {
