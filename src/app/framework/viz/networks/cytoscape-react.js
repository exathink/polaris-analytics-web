...
import {cytoscape, headlessModePatch, initTapMenu, attachTooltips, initPopper} from "./cytoscape";
...
function Cytoscape(
  {
    ...
    tapMenu = {enable: false, menu: () => null, transient: false},
    ...rest
  }, ref) {
